...
\noindent I-Introduction: Description of the figure, as the reader does not gain anything from it at this point. Note: Arrows are confusing. \\
...
\noindent Acknowledgement: Remember to send the final edition of the paper to the persons, to accept the acknowledgements. Otherwise you cannot write them in the paper. \\
...
It seems like there are two meanings of PV power in this sentence, maybe, in any case, it should be written more clearly.
