...
grid on;
grid minor;
title('Continuous Attitude Control');
xlabel('Time [s]');
ylabel('Angle [rad]');
...
grid on;
grid minor;
title('Control Action from the Continuous Controller');
xlabel('Time [s]');
...
grid on;
grid minor;
title('Discrete Attitude Control');
xlabel('Time [s]');
ylabel('Angle [rad]');
...
grid on;
grid minor;
title('Control Action from the Discrete Controller');
xlabel('Time [s]');
ylabel('Motor Rotational Speed [rad/s]');
