...
%
\begin{flalign}
	\eqOne{D(s)} {0,62737 \cdot \frac{(1 + 0,1054\ s)\cdot (1 + 0,6254\ s)}{(1 - 0,1805\ s) \cdot (1 + 0,01\ s) \cdot (1 + 0,005\ s)} =} \eqTwo{= -4582,2 \cdot \frac{(s + 9,488)\cdot (s + 1,599)}{(s - 5,54) \cdot (s + 100) \cdot (s + 200)}} 
