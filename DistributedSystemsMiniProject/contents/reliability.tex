...
%
\begin{flalign}
	P(t_\mathrm{n}\leq t_\mathrm{c})&=\int_{5}^{15}\left[\int_{0}^{t_{\mathrm{c}}}f_{\mathrm{n}}(t)f_{\mathrm{c}}(t)dt_{\mathrm{n}}\right]dt_{\mathrm{c}}\label{eq:integralcase1}
\end{flalign}
...
\begin{flalign}
	...
	F_{\mathrm{n}}(t)&=1-R_{\mathrm{n}}(t)=1-4e^{-2\lambda t}+4e^{-3\lambda t}-e^{-4\lambda t} \label{eq:cumulativecase2b}  \\
	f_{\mathrm{n}}(t)&={F^{\prime}}_{\mathrm{n}}=8 \lambda e^{{-2\lambda t}}-12 \lambda e^{{-3\lambda t}}+4\lambda e^{{-4\lambda t}}\label{eq:probabilitycase2b}  
\end{flalign}
